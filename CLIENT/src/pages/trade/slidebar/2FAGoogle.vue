<template>
        <div class="m-10 gg" v-if="!isActive2FA">
            ...
            <div class="qrcode">
              ...
              <div class="vx-row mb-5 mb-sm-4 items-center ccQR">
                  <div class="md:w-5/12 text-center qr-code-wrap mb-3 mb-md-0">
                      <div class="qr-code-container qr-200 mx-auto">
                          <img height="150" width="150" :src="linkBase64Img" style="height: 150px; width: 150px;">
                      </div>
                  </div>
                  <div class="md:w-7/12">
                      <p class="desc mb-0">
                  ...
                  <div class="md:w-9/12 key pl-0 pr-lg-3 pr-0">
                        <div class="grouplabel">
                            <div class="input-group relative">
                                <vs-input class="w-full" readonly="readonly" icon-pack="feather" icon="icon-copy" icon-after placeholder="icon-after" v-model="MSLuu" />
                    ...
                    <div class="w-full">
                        ...
                        <div class="w-1/5 text-right float-right" style="margin-top: 1rem;">
                            ...
                            <vs-button id="button-with-loading" class="vs-con-loading__container" :disabled="disSendCode" color="success" type="filled" @click.stop="sendCodeSecure()">{{ ssDownSend }}</vs-button>
                        </div>
                    </div>
                    <div class="w-full">
                        <div class="relative">
